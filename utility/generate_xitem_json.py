...
def parse_cmdline():
    ...
    parser.add_argument(
        '--board_file', help="Path of the board.xml file", required=True)
    parser.add_argument('--author', help="Author of the board ", required=True)
    parser.add_argument(
        '--category', help="category the board belongs to.(Single part/ Multi part,...)  ", required=False)
    parser.add_argument('--company_display_name',
                        help="Comapny of the board", required=True, default="")
    parser.add_argument('--company_url', help="Comapny URL ",
                        required=True, default="")
    parser.add_argument('--output_file', help="Refers to the outputfile, default: xitem.json ",
                        required=False, default="xitem.json")
    return parser
